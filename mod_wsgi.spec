...
Source0:        http://github.srcurl.net/GrahamDumpleton/mod_wsgi/%{version}/mod_wsgi-%{version}.tar.gz
Source1:        wsgi.conf
Patch0:         mod_wsgi-4.4.3-cve-regression.patch
...
%else
%if 0%{?el6}
Requires:       %{?scl:httpd24-}httpd >= 2.4.6-20
%endif
%endif
...
%changelog
* Thu Sep 17 2015 Jan Kaluza <jkaluza@redhat.com> - 4.4.3-2
- fix crashes in daemon mode caused by httpd change (#1262975)

* Thu Jan 22 2015 Jan Kaluza <jkaluza@redhat.com> - 4.4.3-1
- updated to version 4.4.3

* Thu Jun 05 2014 Jan Kaluza <jkaluza@redhat.com> - 3.4.15
- fix for CVE-2014-0240 (#1104700)

* Mon Mar 24 2014 Jan Kaluza <jkaluza@redhat.com> - 3.4-13
- remove provides of internal library (#1075680)

* Mon Mar 24 2014 Jan Kaluza <jkaluza@redhat.com> - 3.4-12
- rename mod_wsgi.so to not conflict with other mod_wsgi collections (#1075680)
